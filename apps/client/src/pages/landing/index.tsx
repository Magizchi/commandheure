        ...
        <>
            ...
            <main className="text-primary font-sans">
                <section style={{ backgroundImage: "url(/pattern2.svg)" }} className="flex justify-center items-center h-screen flex-col space-y-5 bg-no-repeat bg-cover">
                    ...
                    <Link to={ROUTES.HEADECOEUR_PRODUCTS} className="bg-main font-bold p-5 text-white rounded-2xl transform hover:scale-105 hover:duration-300 hover:ease-in-out ">ESSAYER LE COMMAND'HEURE</Link>
                </section>
